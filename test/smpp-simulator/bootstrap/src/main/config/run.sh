...
JAVA_OPTS="$JAVA_OPTS -Xms1024m -Xmx1024m -Dsun.rmi.dgc.client.gcInterval=3600000 -Dsun.rmi.dgc.server.gcInterval=3600000"
...
echo "========================================================================="
echo ""
echo "  TeleStax SMPP Load Simulator Test Server Bootstrap Environment"
echo ""
...
echo ""
      ...
      "$JAVA" $JAVA_OPTS \
         ...
         org.mobicents.smsc.server.smpp.bootstrap.Main "$@"
      MMS_STATUS=$?
