...
import org.mobicents.smsc.smpp.SmppServerManagement;
...
public class SMSCShellExecutor implements ShellExecutor {
	...
	private String modifyEsme(String[] args) throws Exception {
		...
		Esme esme = this.smscManagement.getSmppManagement().getEsmeManagement().getEsmeByName(name);
	...
	private String createEsme(String[] args) throws Exception {
		...
		Esme esme = this.smscManagement.getSmppManagement().getEsmeManagement().createEsme(name, systemId, password, host, intPort,
	...
	private String destroyEsme(String[] args) throws Exception {
		...
		Esme esme = this.smscManagement.getSmppManagement().getEsmeManagement().destroyEsme(esmeName);

		return String.format(SMSCOAMMessages.DELETE_ESME_SUCCESSFUL, esmeName);
	}

	private String showEsme() {
		List<Esme> esmes = this.smscManagement.getSmppManagement().getEsmeManagement().getEsmes();
		if (esmes.size() == 0) {
	...
	private String manageSmppServerSet(String[] options) throws Exception {
		...
		SmppServerManagement smppServerManagement = this.smscManagement.getSmppManagement().getSmppServerManagement();
...
//            sb.append("\n");
	...
	private String startEsme(String[] args) throws Exception {
		...
		this.smscManagement.getSmppManagement().getEsmeManagement().startEsme(args[3]);
	...
	private String stopEsme(String[] args) throws Exception {
		...
		this.smscManagement.getSmppManagement().getEsmeManagement().stopEsme(args[3]);
