...
public class PendingRequestsList implements Serializable {
    ...
    public PendingRequestsList(int[] sequenceNumbers, int[][] sequenceNumbersExtra,byte [][][] messagePartsNumbers) {
        ...
        this.messagePartsNumbers = messagePartsNumbers;
            ...
            if (this.sequenceNumbers[i1] == sequenceNumber && !this.confirmations[i1]) {
                ...
                if(this.messagePartsNumbers[i1] != null){
                    if(this.messagePartsNumbers[i1].length > 1){
                        res.messagePartsNumbers = this.messagePartsNumbers[i1][0];
                    }
                }
                if (this.sequenceNumbersExtra[i1] != null)
            ...
            if (this.sequenceNumbersExtra[i1] != null) {
                for (int i2 = 0; i2 < this.sequenceNumbersExtra[i1].length; i2++) {
                    if (this.sequenceNumbersExtra[i1][i2] == sequenceNumber && !this.confirmationsExtra[i1][i2]) {
                        ...
                        res.msgNum = i1;
                        res.splittedMessage = true;
                        res.messagePartsNumbers = this.messagePartsNumbers[i1][i2+1];
